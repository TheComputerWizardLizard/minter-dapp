const contractAddress = "0x7AFEF06Ab04d9210C3c6b3802ce3061DC2993e09"; //Replace with your own contract address
const chain = 'polygon'; // rinkeby or polygon

const welcome_h1 = "Welcome to the America First NFT Campaign!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The America First is a movement that is aimed at supporting all members of America First, and to support any american who has had their 1st amendment right violated trying to express their right to free speech!';
...
const p_presale_coming_soon = "We are working hard to launch the next collection to this campgain!";
...
const p_public_mint = "34 Matic is around 50$ (Prices could increase or decrease based on currency value, if resold on opensea it will be sold under the WETH currency)";
